...
import (
	...
	"AlumniCircle/application/like/rpc/internal/config"
	"AlumniCircle/application/like/rpc/internal/server"
	"AlumniCircle/application/like/rpc/internal/svc"
	"AlumniCircle/application/like/rpc/service"
