...
import (
	...
	"AlumniCircle/application/user/rpc/internal/config"
	"AlumniCircle/application/user/rpc/internal/server"
	"AlumniCircle/application/user/rpc/internal/svc"
	"AlumniCircle/application/user/rpc/service"
	"AlumniCircle/pkg/consul"
