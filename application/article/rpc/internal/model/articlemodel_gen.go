...
var (
	...
	cacheAlumniCircleArticleArticleIdPrefix = "cache:AlumniCircleArticle:article:id:"
)
...
func (m *defaultArticleModel) FindOne(ctx context.Context, id int64) (*Article, error) {
	AlumniCircleArticleArticleIdKey := fmt.Sprintf("%s%v", cacheAlumniCircleArticleArticleIdPrefix, id)
	var resp Article
	err := m.QueryRowCtx(ctx, &resp, AlumniCircleArticleArticleIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultArticleModel) Insert(ctx context.Context, data *Article) (sql.Result, error) {
	AlumniCircleArticleArticleIdKey := fmt.Sprintf("%s%v", cacheAlumniCircleArticleArticleIdPrefix, data.Id)
...
func (m *defaultArticleModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheAlumniCircleArticleArticleIdPrefix, primary)
}
